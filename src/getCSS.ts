...
export const extractAllUnmatchable = (def: StyleDefinition, filter?: SelectionFilter): StyleChunk[] => extractUnmatchableFromAst(def.ast, filter);
...
export const getCriticalRules = (
  ...
  assertIsReady(def);
  return [
    ...extractAllUnmatchable(def, filter),
